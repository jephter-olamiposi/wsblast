...
This repository is a monorepo. For this project, Claude must work only inside the `backend/` folder unless the user explicitly says otherwise.
...
Claude-specific reusable skills live in [.claude/skills](.claude/skills).
