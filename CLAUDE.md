...
Reusable agent skills live in [.claude/skills](.claude/skills).

Before planning and implementing changes, read and follow relevant skills:
- Senior Rust Workflow: `.claude/skills/senior-backend-workflow/SKILL.md`
- Production Code Only: `.claude/skills/production-code-only/SKILL.md`
- Comment Cleanup & Invariant Hygiene: `.claude/skills/comment-cleanup/SKILL.md`
- Performance & Concurrency: `.claude/skills/performance-concurrency/SKILL.md`
- Rust Code Quality: `.claude/skills/rust-code-quality/SKILL.md`
...
6. **Comment Hygiene:** Follow `.claude/skills/comment-cleanup/SKILL.md`. Zero syntax narration comments; preserve only business, concurrency, and `// SAFETY:` invariants.
