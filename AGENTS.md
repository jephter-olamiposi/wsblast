...
Reusable agent skills live in [.agents/skills](.agents/skills).

Before planning and implementing changes, read and follow relevant skills:
- Senior Rust Workflow: `.agents/skills/senior-backend-workflow/SKILL.md`
- Production Code Only: `.agents/skills/production-code-only/SKILL.md`
- Comment Cleanup & Invariant Hygiene: `.agents/skills/comment-cleanup/SKILL.md`
- Performance & Concurrency: `.agents/skills/performance-concurrency/SKILL.md`
- Rust Code Quality: `.agents/skills/rust-code-quality/SKILL.md`
...
6. **Comment Hygiene:** Follow `.agents/skills/comment-cleanup/SKILL.md`. Zero syntax narration comments; preserve only business, concurrency, and `// SAFETY:` invariants.
