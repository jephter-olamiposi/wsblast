...
Reusable agent skills live in [.gemini/skills](.gemini/skills).

Before planning and implementing changes, read and follow relevant skills:
- Senior Rust Workflow: `.gemini/skills/senior-backend-workflow/SKILL.md`
- Production Code Only: `.gemini/skills/production-code-only/SKILL.md`
- Comment Cleanup & Invariant Hygiene: `.gemini/skills/comment-cleanup/SKILL.md`
- Performance & Concurrency: `.gemini/skills/performance-concurrency/SKILL.md`
- Rust Code Quality: `.gemini/skills/rust-code-quality/SKILL.md`
...
6. **Comment Hygiene:** Follow `.gemini/skills/comment-cleanup/SKILL.md`. Zero syntax narration comments; preserve only business, concurrency, and `// SAFETY:` invariants.
