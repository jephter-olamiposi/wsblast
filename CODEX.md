...
This repository is a monorepo. For this project, Codex must work only inside the `backend/` folder unless the user explicitly says otherwise.
...
Codex-specific reusable skills live in [.codex/skills](.codex/skills).
